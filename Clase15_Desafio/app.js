    ...
    cartaMenu.forEach(cartaMenu => {
        ...
        div.innerHTML += `<div class="card" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-primary" id=boton${cartaMenu.id}>Pedir</button>
                            </div>
                        </div>`
...
export function verificoStorage() {
    ...
    let listaProductos = JSON.parse(localStorage.getItem("carritoMenu")) || [];
    // aplico operador1 || operador2 del condicional abajo comentado
/*     let listaProductos;
