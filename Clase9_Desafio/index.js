...
saludoIni.innerHTML = "<h2>Haga click en el botón para ver la carta y cuando guste ingrese el pedido</h2>";
...
if (entrada == 1){
    ...
    FN.setAttribute("name", "Número Pedido");
    FN.setAttribute("placeholder", "Ingrese el número del pedido");
    
    // create a submit button
    let s = document.createElement("input");
    s.setAttribute("type", "submit");
    s.setAttribute("value", "Pedir");
